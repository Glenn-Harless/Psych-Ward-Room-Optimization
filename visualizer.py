...
class Visualizer:
    ...
    def plot_wasted_beds_comparison(self, plot_path):
        ...
        plt.plot(self.current_data['Date'], self.current_data['Wasted Beds'], label='Current Model', marker='o', linestyle='-', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[0])
        plt.plot(self.optimized_data['Date'], self.optimized_data['Wasted Beds'], label='Optimized Model', marker='x', linestyle='--', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[2])
        plt.xlabel('Date')
    ...
    def plot_daily_efficiency_comparison(self, plot_path):
        plt.figure(figsize=(12, 8))
        plt.plot(self.current_data['Date'], self.current_data['Daily Efficiency'], label='Current Model', marker='o', linestyle='-', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[0])
        plt.plot(self.optimized_data['Date'], self.optimized_data['Daily Efficiency'], label='Optimized Model', marker='x', linestyle='--', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[2])
        plt.xlabel('Date')
    ...
    def plot_cumulative_efficiency_comparison(self, plot_path):
        plt.figure(figsize=(12, 8))
        plt.plot(self.current_data['Date'], self.current_data['Cumulative Efficiency'], label='Current Model', marker='o', linestyle='-', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[0])
        plt.plot(self.optimized_data['Date'], self.optimized_data['Cumulative Efficiency'], label='Optimized Model', marker='x', linestyle='--', linewidth=1, markersize=4, color=sns.color_palette("colorblind")[2])
        plt.xlabel('Date')
